...
They also own the ship brief's claim-proof discipline, whose scope reconciliation is mode-conditional: only no-mistakes briefs cite gate-response rules by number.
